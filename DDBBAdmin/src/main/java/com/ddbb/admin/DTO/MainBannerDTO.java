...
public class MainBannerDTO {
	...
	/*
	 * create table mainbanner ( mainbannertitle varchar2(50) not null,
	 * mainbannerimg varchar2(100) not null, mainbannerlink varchar2(100),
	...
	private int mainBannerNum;

	public int getMainBannerNum() {
		return mainBannerNum;
	}

	public void setMainBannerNum(int mainBannerNum) {
		this.mainBannerNum = mainBannerNum;
	}
