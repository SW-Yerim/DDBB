...
<body>
    ...
    <div class="container banner">
        <h1>이벤트 수정</h1>
        <form action="event_update_fin" method="POST" enctype="multipart/form-data" onsubmit="return chkValue()">
            <input type="hidden" name="cuseventnum" value="${param.cuseventnum }">
            <div class="input-wrap">
                <span>제목</span><input type="text" id="eventTitle" name="cusEventTitle" class="input large" value="${cusEventTitle.cusEventTitle }"><br>
                <span>기간</span><input class="input small" id="eventStartDate" name="cusEventStartDate" type="date"> ~ <input class="input small" id="eventEndDate" name="cusEventEndDate" type="date"><br>
                <span>썸네일</span><input type="file" accept=".png,.jpg,.gif" id="eventThumbnailImg" name="cusEventThumbnailImg" class="input large input-file"><br>
                <p class="img-notice">※ a파일 확장자는 png, jpg, gif만 가능합니다.</p>
                <span>본문이미지</span><input type="file" accept=".png,.jpg,.gif" id="eventContentImg"name="cusEventContentsImg" class="input large input-file"><br>
                <p class="img-notice">※ a파일 확장자는 png, jpg, gif만 가능합니다.</p>
            </div>
            <div class="btn-wrap">
