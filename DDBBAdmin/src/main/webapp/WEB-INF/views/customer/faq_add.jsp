...
<body>
    ...
    <div class="container customer faq">
        <h1>자주하는 질문 등록</h1>
        <form action="faq_add_fin" method="POST" onsubmit="return chkValue()">
            <div class="input-wrap">
                <span>제목</span><input type="text" name="faqTitle" id="faqTitle" class="input large"><br>
                <span>내용</span><textarea name="faqContent" id="faqContent" cols="30" rows="10"></textarea>
            </div>
            <div class="btn-wrap">
                <input type="submit" name="faqAdd" class="btn mid" value="등록">
